...
//            pkasi.vaihdaKortti(pakka, pkasi.getKortti(4));
            ...
            this.pkasi = kasi;
            ImageIcon im = new ImageIcon("src/kuvat/" + pkasi.getKortti(0).toString() + ".png");
            kortti1.setIcon(im);
            ImageIcon im2 = new ImageIcon("src/kuvat/" + pkasi.getKortti(1).toString() + ".png");
            kortti2.setIcon(im2);
            ImageIcon im3 = new ImageIcon("src/kuvat/" + pkasi.getKortti(2).toString() + ".png");
            kortti3.setIcon(im3);
            ImageIcon im4 = new ImageIcon("src/kuvat/" + pkasi.getKortti(3).toString() + ".png");
            kortti4.setIcon(im4);
            ImageIcon im5 = new ImageIcon("src/kuvat/" + pkasi.getKortti(4).toString() + ".png");
            kortti5.setIcon(im5);
